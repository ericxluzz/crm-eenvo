<template>
  ...
  >
    ...
    <div v-if="lead.value || lead.shipments" class="valrow">
    ...
    <div class="kc-origin">
      ...
      <span v-if="lead.estado" class="uf-pill"><Icon name="pin" :size="11" />{{ lead.estado }} · {{ lead.regiao }}</span>
    </div>
    ...
    <div v-if="lead.contact.name" class="meta">
